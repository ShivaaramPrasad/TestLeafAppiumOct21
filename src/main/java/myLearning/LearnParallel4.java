...
public class LearnParallel4 {
	@Parameters({ "systemPort", "udid", "avd"})
	@Test
	public void runCode(String systemPort, String udid, String avd) throws MalformedURLException, InterruptedException {
